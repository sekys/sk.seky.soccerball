...
int main( int argc, char** argv )
{
    ...
    for(;;)
    {
        ...
        else if( !points[0].empty() )
        {
            ...
            calcOpticalFlowPyrLK(prevGray, gray, points[0], points[1], status, error);
            size_t i, k;
        ...
        if( addRemovePt && points[1].size() < (size_t)MAX_COUNT )
        {
			...
			// vyhladaj transformaciu 2 bodov estimateRigidTransform
			// bod spadne z hraca na loptu
			// pixeli nam spadnu ked su na hranici s ciarou
